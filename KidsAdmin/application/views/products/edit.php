          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Enter price" value="<?php echo $product_data['barcode']; ?>" autocomplete="off" />
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control select_group" id="attributes_value_id" name="attributes_value_id[]" multiple="multiple">
                        <?php foreach ($v['attribute_value'] as $k2 => $v2): ?>
                          <option value="<?php echo $v2['id'] ?>" <?php if(!empty($attribute_id)){if(in_array($v2['id'], $attribute_id)) { echo "selected"; }} ?>><?php echo $v2['value'] ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>    
                  <?php endforeach ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control select_group" id="brands" name="brands[]" multiple="multiple">
                    <?php foreach ($brands as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if(empty($brand_data)){}else{if(in_array($v['id'], $brand_data)) { echo 'selected="selected"'; } } ?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
                ...
                <div class="form-group col-md-3" id="colomn">
                  ...
                  <select class="form-control select_group" id="category" name="category[]" multiple="multiple">
                    <?php foreach ($category as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if(empty($category_data)){}else {if(in_array($v['id'], $category_data)) { echo 'selected="selected"'; }} ?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
...
<?php $subcategory_data = json_decode($product_data['sub_category_id']); ?>
                
                  <select class="form-control select_group"  id="subcategory"  name="subcategory[]" multiple="multiple">
                    <?php foreach ($subcategory as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if(empty($subcategory_data)){}else{if(in_array($v['id'], $subcategory_data)) { echo 'selected="selected"'; } }?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                  </div>
...
<?php $childsubcategory_data = json_decode($product_data['child_subcategory_id']); ?>
                  ...
                  <select class="form-control select_group"  id="childsubcategory"  name="childsubcategory[]" multiple="multiple">
                    <?php foreach ($childsubcategory as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if(empty($childsubcategory_data)){}else{if(in_array($v['id'], $childsubcategory_data)) { echo 'selected="selected"'; } }?>><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                  </div>
