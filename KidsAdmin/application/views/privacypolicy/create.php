   ...
   <div class="dashboard-ecommerce">
      <div class="container-fluid dashboard-content ">
        <div class="ecommerce-widget">           
            <div class="row">
              <div class="col-md-12 col-lg-12 col-md-6 col-sm-12 box">
                  <div class="card">
                              ...
                              <div class="card-body">
                                <div class="table-responsive">
                                  <div class="form-validation">
                                      <form class="form-valide" action="<?php echo base_url('pages/policy_post')?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
