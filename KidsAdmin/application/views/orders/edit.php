        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group col-md-2 date_order">
                  <label for="date" class="control-label">Date: <?php echo date('Y-m-d') ?></label>
                </div>
                <div class="form-group col-md-10">
                  <label for="time" class="control-label">Time: <?php echo date('h:i a') ?></label>
                </div>

                <div class="">

                    <div class="col-md-4 col-xs-12 order_add">
                ...
                <div class="col-md-12 col-xs-12 gross_amount_box">
                  ...
                  <div class="form-group col-md-4">
                    <label for="service_charge" class="control-label">S-Charge <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="">
                  ...
                  <div class="form-group col-md-4">
                    <label for="vat_charge" class="control-label">Vat <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="">
                  ...
                  <div class="form-group col-md-4">
                    <label for="paid_status" class="control-label">Paid Status</label>
                    <div class="">
