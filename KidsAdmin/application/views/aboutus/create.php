                                      ...
                                      <div class="card-body">
                                         <div class="table-responsive">
                                            <div class="form-validation">
                                               <form class="form-valide" action="<?php echo base_url('pages/about_post')?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                  <div class="form-group row">
                                                     <label class="col-md-3 col-form-label" for="val-username">About Title <span class="text-danger">*</span>
                                                     </label>
                                                     <div class="col-md-9">
                                                  ...
                                                  <div class="form-group row">
                                                     ...
                                                     <div class="col-md-9">
                                                        <input type="file" class="form-control" id="image" name="profile_image" placeholder="..and confirm it!">
                                                     </div>
                                                  </div>
                                                  <div class="form-group row">
