         ...
         <nav class='animated bounceInDown'>
            ...
            <div class="overlay">
              <li><a href="#">Baby Clothes</a></li>
                  <li class="sub-menu">
                    <a href="#kids_cloths">Kids Cloth
                      <span class="right">
                        <i class="fa fa-chevron-down"></i>
                      </span>
                    </a>
                    <ul style="display: none;">
                      <li><a href="#kids_cloths">All</a></li>
                      <li><a href="#kids_cloths">Boy's</a></li>
                      <li><a href="#kids_cloths">Girl's</a></li>
                      <li><a href="#kids_cloths">Accessories</a></li>
                      <li><a href="#kids_cloths">Specials</a></li>
                    </ul>
                  </li>
               <!-- <ul>
