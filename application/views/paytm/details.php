                 ...
                 <div class="col-sm-6">
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <input type="text" name="first_name" class="form-control" value="<?php echo $this->session->userdata('firstname'); ?>" readonly>
                        ...
                        <div class="col-sm-6">
                           ...
                           <input type="text" name="last_name" class="form-control" value="<?php echo $this->session->userdata('lastname'); ?>" readonly>
